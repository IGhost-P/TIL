...
module.hot.accept 와 module.hot.dispose 두 메소드를 알아 두세요. module.hot.accept를 이 모듈이나 이 모듈의 다른 의존 사항이 갱신될 때 실행되는 콜백과 함께 호출합니다. module.hot.dispose는 이 모듈이 교체될 때 호출되는 콜백을 받아들입니다.
